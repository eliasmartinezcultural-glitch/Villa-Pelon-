/* WORLD MASTER V1 — GEOMETRÍA TERRITORIAL ÚNICA
   ...
   Este archivo reemplaza la geometría heredada: no parchea coordenadas antiguas.
   Orden territorial: urbano compacto -> rural productivo -> río -> Picada 21 remota.
*/
(()=>{'use strict';
...
/* 1. EDIFICIOS — separados por territorio y sin ocupar el río */
const buildings=[
...
/* 2. CALLES — densidad urbana sólo en el núcleo */
const roads=[
 R('urban_north',300,600,4700,120,'Avenida Norte'),R('urban_mid',300,1100,4700,120,'Avenida Central'),
 R('urban_south',300,1750,4700,120,'Avenida Sur'),R('urban_service',300,2300,4700,120,'Camino de Servicios'),
 R('urban_vertical_01',450,600,120,1820,'Calle Oeste'),R('urban_vertical_02',1050,600,120,1820,'Calle Escuela'),
 R('urban_vertical_03',1750,600,120,1820,'Calle Cívica'),R('urban_vertical_04',2300,600,120,1820,'Calle Biblioteca'),
 R('urban_vertical_05',2850,600,120,1820,'Calle Salud'),R('urban_vertical_06',3400,600,120,1820,'Calle Bomberos'),
 R('urban_vertical_07',3950,600,120,1820,'Calle Comunitaria'),R('urban_vertical_08',4480,600,120,1820,'Calle Capilla'),
...
/* 3. RÍO — independiente del urbano; ningún edificio puede ocuparlo */
...
const routeNetwork={version:'WORLD_MASTER_V1',nodes:[
 {id:'plaza',x:1380,y:880,zone:'urban_core'},{id:'urban_exit',x:4700,y:1160,zone:'urban_core'},
 ...
 ['productive','river_west_bridge'],['productive','river_east_bridge'],['river_west_bridge','picada_gate'],
 ['river_east_bridge','picada_gate'],['picada_gate','picada21']
],rule:'El núcleo urbano no continúa físicamente dentro de Picada 21; el río sólo se cruza por puentes.'};
const worldRules={
 version:'WORLD_MASTER_V1',worldSize:[8200,4200],
...
V.worldManifest={version:'WORLD_MASTER_V1',worldSize:[8200,4200],urban:{x:300,y:500,w:4200,h:1950},rural:{x:4300,y:500,w:3900,h:2300},river,picada21:{x:4900,y:3450,w:3200,h:500},zones,bridges,roads,worldRules};
V.worldRules=worldRules;V.world={...W,w:8200,h:4200,waterY:river.y,waterHeight:river.h};
V.educationalRule='Villa Pelón es una reconstrucción RPG educativa inspirada en San Patricio del Chañar; hechos históricos y ficción deben distinguirse.';
V.educationalProgress=V.educationalProgress||{chaptersCompleted:[],factsLearned:[],sourcesChecked:[],fictionWarnings:[]};
V.worldMaster={version:'WORLD_MASTER_V1',locked:true,authority:'core/world_master_v1.js'};
