/* VILLA PELÓN V106.4 — CONTRATO DE ARQUITECTURA
...
function rendererAuthority(){const rc=V.renderCompositor||V.render;if(!rc)return null;rc.singleRAF=true;rc.ownsBuildingFacades=true;const bd=V.buildingDetail=V.buildingDetail||{};bd.version='106.4';bd.distinctive=true;bd.renderOwner='render_compositor_v93';return rc}
