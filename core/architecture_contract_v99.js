...
function rendererAuthority(){
  ...
  bd.version='106.6';bd.distinctive=true;bd.renderOwner='render_compositor_v93';
  return rc;
}
function rendererOK(base){
  const rc=rendererAuthority();
  return !!rc && (rc.ownsBuildingFacades===true || base?.singleBuildingRenderer===true);
}
