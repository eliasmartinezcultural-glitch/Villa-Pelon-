...
function sync(){const base=baseHealth(),render=rendererOK(base),life=lifeOK(),world=worldOK();E.singleBuildingRenderer=true;E.npcNavigation='bridge-aware';E.worldRules='bridge-only';E.health=health;V.architectureContract={version:'106.6',singleEngine:true,singleBuildingRenderer:true,buildingRendererOwner:render?'render_compositor_v93':null,singleVillageLife:life,lifeSaveAuthority:life?'gameState':null,npcNavigation:'bridge-aware',pixelArt:true,worldRules:world,geometryContract:!!V.worldGeometry?.geometryContract,worldAuthority:worldAuthority()};return render&&life&&world}
