/* VILLA PELÓN — RENDER COMPOSITOR V102
...
V.renderCompositor={version:'102.0',singleRAF:true,historicalLayer:true,visualStyle:'fine-pixel-art',ownsBuildingFacades:true,detailLevel:'high'};requestAnimationFrame(frame);
})();
