/* VILLA PELÓN — INTEGRITY GATE V94
   Última capa de coherencia: valida y corrige referencias compartidas sin dibujar,
   mover personajes ni crear otro loop. Es deliberadamente idempotente.
*/
(()=>{'use strict';
...
function validate(){
  ...
  G.integrity=Object.assign(G.integrity||{},{version:'94.0',worldSize:WORLD,picada21:{stop:{x:7550,y:2350},route:'picada21_route'},checkedAt:Date.now()});
  normalizeState();
