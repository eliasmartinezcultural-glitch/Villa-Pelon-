...
const WORLD={w:8200,h:4200,version:'90.3'};
V.world=Object.assign(V.world||{},WORLD);
M.worldSize={w:WORLD.w,h:WORLD.h};M.version='90.3';G.version='90.3';
...
G.integrity={version:'90.3',worldSize:{w:WORLD.w,h:WORLD.h},picada21:{stop:{x:stop.x,y:stop.y},route:M.picada21.route},checkedAt:Date.now()};
V.worldApi=V.worldApi||{};V.worldApi.version='90.3';
...
/* Contrato único de guardado para Runtime Core, integración y futuras capas online. */
