/* VILLA PELÓN — WORLD MANIFEST V92
   Fuente única de geometría jugable. Viviendas separadas de las calzadas.
*/
(()=>{'use strict';
 const V=window.VillaPelon||(window.VillaPelon={});
 V.world=Object.assign(V.world||{},{w:8200,h:4200,version:'92.0'});
 ...
 const buildings=[
  ...
  B(1100,1120,400,230,'RADIO OASIS','radio'), B(1650,1120,330,210,'CLUB OCARINA','culture'), B(2120,1120,330,210,'FERRETERÍA','shop'),
  B(2590,1120,330,210,'TALLER','service'), B(3060,1120,330,210,'PANADERÍA','shop'), B(3550,1120,360,230,'DEPÓSITO','service'), B(4050,1120,360,230,'VIVERO','rural'),
  ...
  B(5200,1760,470,280,'BODEGA FAMILIAR','winery'), B(5900,1780,430,260,'GALPÓN DE HERRAMIENTAS','rural'), B(6600,1740,430,260,'VIVIENDA RURAL','home'), B(7300,1800,430,260,'QUINTA','rural')
 ];
 ...
 const roads=[{x:0,y:600,w:4900,h:190},{x:0,y:880,w:4900,h:110},{x:1070,y:0,w:190,h:1900},{x:0,y:1040,w:4900,h:110},{x:4700,y:0,w:120,h:4200},{x:0,y:2120,w:8200,h:130}];
 V.worldGeometry={...(V.worldGeometry||{}),buildings,bridges,roads,version:'92.0'};
 V.worldManifest={version:'92.0',urban:{x:0,y:0,w:4900,h:1900},rural:{x:4900,y:0,w:3300,h:4200},river:{x:0,y:820,w:8200,h:22},bridges};
})();
