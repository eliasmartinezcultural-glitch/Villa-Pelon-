/* Villa Pelón V47 — arquitectura visual del mundo.
   Capa pixel-art territorial: calles, veredas, cercos, servicios, fachadas,
   plaza y chacras. Se dibuja antes de la vida autónoma para conservar profundidad. */
(()=>{'use strict';
