/* Villa Pelón V77 — agenda diaria territorial.
   Una autoridad de rutina: la vida de cada NPC se decide por hora, rol y clima.
   V76 se ocupa de llevarlo hasta allí por un camino válido.
*/
(()=>{'use strict';
