/* Villa Pelón V74.1 — autoridad única de interacción y navegación. */
(()=>{'use strict';
const V=window.VillaPelon||(window.VillaPelon={});
const A={version:'V74.1',last:null};
...
function install(){
 ...
 V.territory=V.territory||{};V.territory.zoneAt=zoneAt;V.navigation74={version:'V74.1',zoneAt,blocked};
